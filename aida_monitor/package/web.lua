...
*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font:14px/1.5 ui-monospace,SFMono-Regular,Consolas,"Microsoft YaHei",monospace}.page{width:min(920px,calc(100% - 24px));margin:auto;padding:22px 0}.head{display:flex;justify-content:space-between;gap:16px;align-items:end;margin-bottom:14px}h1{margin:0;font-size:24px}.sub{color:var(--muted);margin:3px 0 0}.grid{display:grid;grid-template-columns:1fr .86fr;gap:12px}.panel{border:1px solid var(--line);background:var(--panel);padding:16px}.panel h2{font-size:15px;margin:0 0 13px;color:var(--cyan)}.form{display:grid;gap:12px}.row{display:grid;grid-template-columns:1fr 130px;gap:10px}label{display:block;color:var(--muted);font-size:12px;margin-bottom:5px}input,select{width:100%;height:40px;border:1px solid var(--line);background:#090d13;color:var(--text);padding:0 10px;font:inherit;outline:none}input:focus,select:focus{border-color:var(--cyan)}.font-guide{border-top:1px dashed var(--line);padding-top:12px}.font-command{display:flex;align-items:baseline;justify-content:space-between;gap:12px;border-bottom:1px solid var(--line);padding-bottom:8px}.font-command span{color:var(--muted);font-size:11px;letter-spacing:.12em}.font-command strong{color:var(--green);font-size:15px}.font-meta{display:flex;gap:7px;flex-wrap:wrap;margin:8px 0}.font-meta code{border:1px solid var(--line);background:#090d13;padding:2px 6px;font-size:11px}.subpixel-row{display:grid;grid-template-columns:1fr 130px;gap:10px;align-items:end;margin:8px 0}.subpixel-row small{display:block;color:var(--muted)}.font-copy{margin:6px 0;color:var(--muted);font-size:12px}.font-actions{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:8px}.font-state{font-size:11px}.font-download{color:var(--cyan);font-size:12px;text-decoration:none;border-bottom:1px solid currentColor}button,a.button{height:40px;border:1px solid var(--line);background:#141c27;color:var(--text);padding:0 13px;font:inherit;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center}.primary{background:var(--cyan);border-color:var(--cyan);color:#05111a;font-weight:800}.actions{display:flex;gap:8px;flex-wrap:wrap}.status{min-height:21px;color:var(--muted)}.status.ok{color:var(--green)}.status.err{color:var(--red)}.runtime{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin-bottom:13px}.metric{border:1px solid var(--line);background:#090d13;padding:9px}.metric b{display:block;color:var(--cyan);font-size:18px}.metric b.warn{color:var(--red)}.metric span{color:var(--muted);font-size:11px}.steps{margin:0;padding-left:20px;color:var(--muted)}.steps li{margin:9px 0}.steps strong{color:var(--text)}code{color:var(--green);overflow-wrap:anywhere}.note{border-left:2px solid var(--cyan);padding:8px 10px;background:#0b121b;color:var(--muted)}@media(max-width:720px){.grid{grid-template-columns:1fr}.row,.subpixel-row{grid-template-columns:1fr}.head{align-items:start}.runtime{grid-template-columns:repeat(2,1fr)}.font-command,.font-actions{align-items:flex-start;flex-direction:column}}
